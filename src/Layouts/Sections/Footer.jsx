...
export default function Footer() {
    return (
        <div className=' mt-[80px]'>
            <div className="footer-Inner px-[100px] bg-[#F0F0F0] pt-[140px] pb-[80px]">
                <div className="list-Footer-Col flex items-start justify-between mb-[40px]">
                    <div>
                        <div className="list-Footer-Col-1">
                            <p className="logo font-bold text-[33.45px] leading-[auto]">FourBird</p>
                            <p className="items-Footer-title w-[248px] mt-[25px]">We have clothes that suits your style and which you’re proud to wear. From women to men.</p>
                            <div className="icon flex flex-row items-center gap-[16px] mt-[35px]">
                    ...
                    <div>
                        <ul className='list-Footer-Col-2 flex flex-col gap-[16px]'>
                            <li className='text-[16px] font-medium leading-[18px] mb-[10px] tracking-[3px]'>Company</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>About</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Features</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Works</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Career</li>
                        </ul>
                    </div><div>
                        <ul className='list-Footer-Col-3 flex flex-col gap-[16px]'>
                            <li className='text-[16px] font-medium leading-[18px] mb-[10px] tracking-[3px]'>Company</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>About</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Features</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Works</li>
                        ...
                        <ul className='list-Footer-Col-4 flex flex-col gap-[16px]'>
                            <li className='text-[16px] font-medium leading-[18px] mb-[10px] tracking-[3px]'>Company</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>About</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Features</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Works</li>
                        ...
                        <ul className='list-Footer-Col-5 flex flex-col gap-[16px]'>
                            <li className='text-[16px] font-medium leading-[18px] mb-[10px] tracking-[3px]'>Company</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>About</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Features</li>
                            <li className='font-regular text-[16px] leading-[19px] tracking-[0] text-[rgba(0,0,0,0.6)]'>Works</li>
                ...
                <div className="copy-right pt-[20px] border-t border-t-[rgba(0,0,0,0.1)] flex items-center justify-between">
                    <p className="text-copyright font-normal text-[14px] leading-[auto]">Shop.co © 2000-2023, All Rights Reserved</p>
                    <div className="icon flex flex-row gap-[12px]">
                        <img src="./assets/imgs/applePay.png" alt="" />
                        <img src="./assets/imgs/applePay.png" alt="" />
